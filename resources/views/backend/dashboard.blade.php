            ...
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    <div>
                        ...
                        <h5 class="text-white op-7 mb-2">Database Perizinan Departemen License</h5>
                    </div>
            ...
            <div class="row mt--2">
                <div class="col-md-6">
                    <div class="card full-height">
                        <div class="card-body">
                            <div class="card-title">Jumlah Perizinan</div>
                            <div class="card-category">Daily information about statistics in system</div>
                            <div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
                                <div class="px-2 pb-2 pb-md-0 text-center">
                                    <div id="circles-1"></div>
                                    <h6 class="fw-bold mt-3 mb-0">Perizinan Aktif</h6>
                                </div>
                                <div class="px-2 pb-2 pb-md-0 text-center">
                                    <div id="circles-2"></div>
                                    <h6 class="fw-bold mt-3 mb-0">Perizinan Baru</h6>
                                </div>
                                <div class="px-2 pb-2 pb-md-0 text-center">
                                    <div id="circles-3"></div>
                                    <h6 class="fw-bold mt-3 mb-0">Perpanjang Perizinan</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ url('backend/img/flags/id.png') }}"
                                                                alt="indonesia">
                                                        </div>
                                                    </td>
                                                    <td>Indonesia</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ url('backend/img/flags/us.png') }}"
                                                                alt="united states">
                                                        </div>
                                                    </td>
                                                    <td>USA</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ url('backend/img/flags/au.png') }}"
                                                                alt="australia">
                                                        </div>
                                                    </td>
                                                    <td>Australia</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ url('backend/img/flags/ru.png') }}" alt="russia">
                                                        </div>
                                                    </td>
                                                    <td>Russia</td>
                                                    <td class="text-right">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ url('backend/img/flags/cn.png') }}" alt="china">
                                                        </div>
                                                    </td>
                                                    <td>China</td>
                                                    <td class="text-right">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ url('backend/img/flags/br.png') }}" alt="brazil">
                                                        </div>
                                                    </td>
                                                    <td>Brasil</td>
                                                    <td class="text-right">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body pb-0">
                            <div class="d-flex">
                                <div class="avatar">
                                    <img src="{{ url('backend/img/logoproduct.svg') }}" alt="..."
                            ...
                            <div class="d-flex">
                                <div class="avatar">
                                    <img src="{{ url('backend/img/logoproduct3.svg') }}" alt="..."
                                        class="avatar-img rounded-circle">
                                </div>
                                <div class="flex-1 pt-1 ml-2">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="card-list">
                                <div class="item-list">
                                    <div class="avatar">
                                        <img src="{{ url('backend/img/jm_denis.jpg') }}" alt="..."
                                            class="avatar-img rounded-circle">
                                    </div>
                                ...
                                <div class="item-list">
                                    <div class="avatar">
                                        <img src="{{ url('backend/img/chadengle.jpg') }}" alt="..."
                                            class="avatar-img rounded-circle">
                                    </div>
                                    <div class="info-user ml-3">
                                ...
                                <div class="item-list">
                                    <div class="avatar">
                                        <img src="{{ url('backend/img/talha.jpg') }}" alt="..."
                                            class="avatar-img rounded-circle">
                                    </div>
                                    <div class="info-user ml-3">
                                ...
                                <div class="item-list">
                                    <div class="avatar">
                                        <img src="{{ url('backend/img/mlane.jpg') }}" alt="..."
                                            class="avatar-img rounded-circle">
                                    </div>
                                    <div class="info-user ml-3">
